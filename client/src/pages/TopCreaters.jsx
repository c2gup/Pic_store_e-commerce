...
export default function TopCreaters() {
    ...
    return (
        <div className="min-h-screen w-[85%]  m-auto justify-end bg-cover bg-center">
            <div className="upper_creaters flex justify-between items-center">
                <div className="left_upper_creater p-5 m-5">
                    <h1 className="text-3xl font-serif font-bold text-white">Top Creators</h1>
                    <p className="text-slate-400">Checkout Top Rated Creators On The NFT Marketplace</p>
                </div>
